        ...
        <div class="mt-6">
            <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg">
                ...
                <div class="bg-white px-8 pb-8 pt-0 shadow sm:rounded-lg">
                    <form action="{{ route('admin.types.store') }}" method="POST" class="space-y-4 needs-validation"
                        novalidate>
                        @csrf
                        <label class="form-control w-full">
                            ...
                            <input type="text" name="name" placeholder="Tên loại hình văn bản..."
                                @class([
                                    'border',
                                    'border-gray-300',
                                    'bg-white',
                        ...
                        <div class="flex justify-end gap-4">
                            <a href="{{ route('admin.types.index', request()->query()) }}" class="btn-light btn">
