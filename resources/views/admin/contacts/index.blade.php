                    ...
                    <table class="table text-black text-base">
                        ...
                        <thead class="text-black text-base">
                            <tr>
                                ...
                                <th class="text-center font-semibold">@lang('admin.contacts.name')</th>
                                <th class="text-center font-semibold">@lang('admin.contacts.email')</th>
                                <th class="text-center font-semibold">@lang('admin.contacts.phone')</th>
                                <th class="text-center font-semibold">@lang('admin.contacts.read_at')</th>
                                <th class="text-center font-semibold">@lang('admin.contacts.created_at')</th>
                        ...
                        <tbody>
                            @foreach ($contacts as $contact)
                                <tr>
                                    <th class="text-center">{{ $contacts->firstItem() + $loop->index }}</th>
                                    <td class="text-center">{{ $contact->name }}</td>
                                    <td class="text-center">{{ $contact->email }}</td>
                                    <td class="text-center">{{ $contact->phone }}</td>
                                    <td class="text-center">{{ $contact->read_at }}</td>
