<x-app-layout>
    ...
    <div class="p-6 ">
        <div class="flex justify-between">
            ...
            <a class="bg-blue-700 btn border-blue-500 " href="{{ route('admin.categories.create',request()->query()) }}">
                            ...
                            @foreach ($categories as $category)
                                <tr>
                                    ...
                                    @if ($category->parent()->exists())
                                        <td class="text-left">{{ $category->parent->title }} / {{ $category->title }}
                                        </td>
                                    @else
                                        <td class="text-left">Danh mục cha</td>
                                    @endif
                                    ...
                                    <td class="flex gap-3 items-center justify-center">
                                        <a
                                            href="{{ route('admin.categories.edit', [$category->id] + request()->query()) }}"><x-heroicon-s-pencil-square
