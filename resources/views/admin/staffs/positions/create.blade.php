        ...
        <div class="mt-6">
            <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg">
                ...
                <div class="bg-white px-8 pb-8 pt-0 shadow sm:rounded-lg">
                    <form action="{{ route('admin.positions.store') }}" method="POST" class="space-y-4 needs-validation"
                        novalidate>
                        @csrf
                        ...
                        <div class="flex justify-end gap-4">
                            <a href="{{ route('admin.positions.index',request()->query()) }}" class="btn-light btn">
